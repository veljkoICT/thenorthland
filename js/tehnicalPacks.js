window.onload = function(){
   ...
   localStorage.setItem("brojac","dontShow");
    var pokupi = localStorage.getItem("brojac");
    $(".popUp").hide();
    ispisFutera();
   // $(".cbx1").clic(function())
...
function ispisLiKorpa(){
    ...
    var ispis = "";
    promenljiva = 0;
    ispis += `<a><i class="fa fa-shopping-basket" id="korpaIkonica" aria-hidden="true">&nbsp;` + promenljiva; ispis+=`</i></a>`;
    li.innerHTML = ispis;
}
